...
const POS8583PACKET_STRC TrTable[TRACE_NUM] = { //
	{POS_ECHO, "900010", NO_ACTION, "00", "00", "301", "0820", "0830", "0400", {0x00, 0x00, 0x00, 0x00, 0x00, 0xC0, 0x00, 0x10}, {0x21, 0x99, 0x08, 0x10, 0x02, 0xB0, 0x00, 0xF4}},
	{POS_LOGON, "900010", ACTTRACEADD, "00", "00", "001", "0800", "0810", "0400", {0x00, 0x20, 0x00, 0x00, 0x00, 0xC0, 0x00, 0x12}, {0x21, 0x99, 0x08, 0x10, 0x02, 0xB0, 0x00, 0xF4}},
	{POS_SALE, "000000", ACTPRINT + ACTREVERSAL + ACTLOG + ACTTRACEADD, "00", "22", "000", "0200", "0210", "0400", {0x70, 0x24, 0x06, 0xC0, 0x30, 0xC0, 0x9A, 0x11}, {0x70, 0x24, 0x06, 0x80, 0x36, 0xc0, 0x82, 0x11}},
	{POS_SALE_VOID, "200000", ACTPRINT + ACTREVERSAL + ACTLOG + ACTTRACEADD, "00", "23", "000", "0200", "0210", "0400", {0x70, 0x20, 0x06, 0xC0, 0x3C, 0xc0, 0x98, 0x19}, {0x70, 0x24, 0x06, 0x80, 0x36, 0xC0, 0x82, 0x19}},
	{POS_QUE, "310000", ACTTRACEADD, "00", "01", "000", "0200", "0210", "0400", {0x60, 0x24, 0x06, 0xc0, 0x30, 0xC0, 0x9A, 0x11}, {0x00, 0x20, 0x00, 0x00, 0x02, 0x80, 0x00, 0x00}},
	{POSPARAM_DOWN, "900000", ACTTRACEADD, "00", "00", "360", "0800", "0810", "0400", {0x00, 0x00, 0x00, 0x00, 0x00, 0xC0, 0x00, 0x10}, {0x00, 0x00, 0x00, 0x00, 0x00, 0x80, 0x00, 0x00}},
	{POSPARAM_DOWNEND, "900000", ACTTRACEADD, "00", "00", "361", "0800", "0810", "0400", {0x00, 0x00, 0x00, 0x00, 0x00, 0xC0, 0x00, 0x10}, {0x00, 0x00, 0x00, 0x00, 0x00, 0x80, 0x00, 0x00}},
	{SYS_SIGNUPLOAD, "000000", ACTTRACEADD, //5022000008C00210
	 ...
	 "0830",
	 "0400",
	 {0x50, 0x20, 0x02, 0x00, 0x08, 0xC0, 0x42, 0x13},
	 {0x00, 0x00, 0x00, 0x00, 0x00, 0x80, 0x00, 0x00}},
	//emv�ཻ��
	{EMVCAPK_DOWN, "900000", ACTTRACEADD, "02", "00", "370", "0800", "0810", "0400", {0x00, 0x00, 0x00, 0x00, 0x00, 0xC0, 0x00, 0x14}, {0x00, 0x00, 0x00, 0x00, 0x00, 0x80, 0x00, 0x00}},
	{EMVPARAM_DOWN, "900000", ACTTRACEADD, "02", "00", "380", "0800", "0810", "0400", {0x00, 0x00, 0x00, 0x00, 0x00, 0xC0, 0x00, 0x14}, {0x00, 0x00, 0x00, 0x00, 0x00, 0x80, 0x00, 0x00}},
	{EMVCAPK_QUERYIDX, "000000", ACTTRACEADD, "00", "00", "372", "0820", "0830", "0440", {0x00, 0x00, 0x00, 0x00, 0x00, 0xC0, 0x00, 0x14}, {0x00, 0x00, 0x00, 0x00, 0x00, 0x80, 0x00, 0x00}},
	{EMVCAPK_END, "000000", ACTTRACEADD, "00", "00", "371", "0800", "0810", "0440", {0x00, 0x00, 0x00, 0x00, 0x00, 0xC0, 0x00, 0x10}, {0x00, 0x00, 0x00, 0x00, 0x00, 0x80, 0x00, 0x00}},
	{EMVPARAM_QUERYIDX, "000000", ACTTRACEADD, "00", "00", "382", "0820", "0830", "0440", {0x00, 0x00, 0x00, 0x00, 0x00, 0xC0, 0x00, 0x14}, {0x00, 0x00, 0x00, 0x00, 0x00, 0x80, 0x00, 0x00}},
	{EMVPARAM_END, "000000", ACTTRACEADD, "00", "00", "381", "0800", "0810", "0440", {0x00, 0x00, 0x00, 0x00, 0x00, 0xC0, 0x00, 0x10}, {0x00, 0x00, 0x00, 0x00, 0x00, 0x80, 0x00, 0x00}},
	/*������׼Ӧ��*/
	{POS_PREAUTH, "030000", ACTPRINT + ACTREVERSAL + ACTLOG + ACTTRACEADD, "06", "10", "000", "0100", "0110", "0400", {0x70, 0x24, 0x06, 0xC0, 0x30, 0xC0, 0x9A, 0x11}, {0x70, 0x24, 0x06, 0x80, 0x06, 0xc0, 0x82, 0x11}},
	{POS_PREAUTH_VOID, "200000", ACTPRINT + ACTREVERSAL + ACTLOG + ACTTRACEADD, "06", "11", "000", "0100", "0110", "0400", {0x70, 0x24, 0x06, 0xC0, 0x34, 0xc0, 0x98, 0x19}, {0x70, 0x24, 0x06, 0x80, 0x06, 0xC0, 0x82, 0x19}},
	{POS_PREAUTH_DONE, "000000", ACTPRINT + ACTREVERSAL + ACTLOG + ACTTRACEADD, "06", "20", "000", "0200", "021", "0400", {0x70, 0x24, 0x04, 0xC0, 0x34, 0xC0, 0x98, 0x19}, {0x70, 0x24, 0x04, 0x80, 0x06, 0xC0, 0x82, 0x19}},
	{POS_AUTH_VOID, "200000", ACTPRINT + ACTREVERSAL + ACTLOG + ACTTRACEADD, "06", "21", "000", "0200", "0210", "0400", {0x70, 0x24, 0x04, 0xC0, 0x3c, 0xc0, 0x98, 0x19}, {0x70, 0x24, 0x04, 0x80, 0x06, 0xC0, 0x82, 0x19}},
	{POS_PREAUTH_ADD, "030000", ACTPRINT + ACTREVERSAL + ACTLOG + ACTTRACEADD, "06", "12", "000", "0100", "0110", "0400", {0x70, 0x24, 0x06, 0xC0, 0x30, 0xC0, 0x9A, 0x11}, {0x70, 0x24, 0x06, 0x80, 0x06, 0xc0, 0x82, 0x11}},
	{POS_REFUND, "200000", ACTPRINT + ACTREVERSAL + ACTLOG + ACTTRACEADD, "00", "25", "000", "0220", "0230", "0400", {0x70, 0x24, 0x06, 0xC0, 0x38, 0xC0, 0x98, 0x1B}, {0x70, 0x24, 0x06, 0x80, 0x06, 0xC0, 0x80, 0x19}},
	{POS_INST, "000008", ACTPRINT + ACTREVERSAL + ACTLOG + ACTTRACEADD, "64", "40", "000", "0200", "0210", "0400", {0x70, 0x24, 0x06, 0xC0, 0x30, 0xC2, 0x9A, 0x17}, {0x70, 0x24, 0x06, 0x80, 0x06, 0xC0, 0x80, 0x19}},
	{POS_INSTVOID, "200008", ACTPRINT + ACTREVERSAL + ACTLOG + ACTTRACEADD, "64", "41", "000", "0200", "0210", "0400", {0x70, 0x24, 0x06, 0xC0, 0x3C, 0xC0, 0x98, 0x1B}, {0x70, 0x24, 0x06, 0x80, 0x06, 0xC0, 0x80, 0x19}},
	{POS_INSTREFUND, "210008", ACTPRINT + ACTLOG + ACTTRACEADD, "64", "41", "000", "0200", "0210", "0400", {0x70, 0x24, 0x04, 0xC0, 0x3C, 0xC0, 0x98, 0x1F}, {0x70, 0x24, 0x06, 0x80, 0x06, 0xC0, 0x80, 0x19}},
	{POS_INSTQUERY, "310008", ACTTRACEADD, "64", "42", "000", "0200", "0210", "0400", {0x60, 0x24, 0x04, 0xC0, 0x30, 0xE0, 0x98, 0x13}, {0x70, 0x24, 0x06, 0x80, 0x06, 0xC0, 0x80, 0x19}},
	{POS_LOGOFF, "000000", ACTTRACEADD, "00", "00", "002", "0820", "0830", "0400", {0x00, 0x20, 0x00, 0x00, 0x00, 0xc0, 0x00, 0x10}, {0x00, 0x00, 0x00, 0x00, 0x00, 0x80, 0x00, 0x00}},
	{POS_SETTLE, "000000", ACTTRACEADD, "00", "00", "201", "0500", "0510", "0400", {0x00, 0x20, 0x00, 0x00, 0x00, 0xc1, 0x80, 0x12}, {0x00, 0x00, 0x00, 0x00, 0x00, 0x80, 0x00, 0x00}},
	{POS_BATCHUP, "000000", ACTTRACEADD, "00", "00", "201", "0320", "0330", "0400", {0x50, 0x20, 0x06, 0x00, 0x00, 0xc0, 0x02, 0x14}, {0x00, 0x00, 0x00, 0x00, 0x00, 0x80, 0x00, 0x00}},
	{ICC_BATCHUP_TC, "000000", ACTTRACEADD, "61", "00", "203", "0320", "0330", "0400", {0x50, 0x20, 0x06, 0x00, 0x00, 0xc0, 0x02, 0x14}, {0x00, 0x00, 0x00, 0x00, 0x00, 0x80, 0x00, 0x00}},
	{ICC_SCRSEND, "000000", ACTTRACEADD, "00", "00", "951", "0620", "0630", "0400", {0x70, 0x20, 0x06, 0x00, 0x0C, 0xC0, 0x82, 0x19}, {0x00, 0x00, 0x00, 0x00, 0x00, 0x80, 0x00, 0x00}},
	{TMS_QUERY, "410000", NO_ACTION, "00", "00", "000", "4100", "4110", "0420", {0x20, 0x00, 0x00, 0x00, 0x00, 0xc0, 0x00, 0x03}, {0x20, 0x00, 0x00, 0x00, 0x02, 0xc0, 0x00, 0x03}},

	//
	{POINTS_WASHCAR, "930000", ACTPRINT + ACTREVERSAL + ACTLOG + ACTTRACEADD, "65", "53", "000", "0200", "0210", "0400", {0x60, 0x24, 0x06, 0xC0, 0x30, 0xC0, 0x18, 0x11}, {0x60, 0x24, 0x06, 0xC0, 0x30, 0xC0, 0x18, 0x11}},
	{POINTSCASH_SALEVOID, "200009", ACTPRINT + ACTREVERSAL + ACTLOG + ACTTRACEADD, "65", "72", "000", "0200", "0210", "0400", {0x70, 0x24, 0x06, 0xC0, 0x38, 0xC0, 0x98, 0x1D}, {0x70, 0x24, 0x06, 0xC0, 0x38, 0xC0, 0x98, 0x1D}},
	{POINTSCASH_PREQUE, "100009", ACTTRACEADD, "65", "50", "000", "0200", "0210", "0400", {0x70, 0x24, 0x04, 0xC0, 0x30, 0xC0, 0x98, 0x11}, {0x50, 0x20, 0x00, 0x00, 0x0a, 0x80, 0x00, 0x00}},
	{POINTSCASH_SALE, "000009", ACTPRINT + ACTREVERSAL + ACTLOG + ACTTRACEADD, "65", "71", "000", "0200", "0210", "0400", {0x70, 0x24, 0x04, 0xC0, 0x30, 0xC0, 0x98, 0x15}, {0x70, 0x24, 0x04, 0x80, 0x32, 0xC0, 0x80, 0x15}},
	{POINTS_QUERY, "310009", ACTTRACEADD, "65", "52", "000", "0200", "0210", "0400", {0x60, 0x24, 0x04, 0xC0, 0x30, 0xC0, 0x18, 0x11}, {0x50, 0x20, 0x00, 0x00, 0x0a, 0x80, 0x00, 0x00}},
	{POINTS_REFUND, "200009", ACTPRINT + ACTREVERSAL + ACTLOG + ACTTRACEADD, "65", "52", "000", "0220", "0230", "0400", {0x70, 0x24, 0x06, 0xC0, 0x3C, 0xC1, 0x98, 0x11}, {0x50, 0x20, 0x00, 0x00, 0x0a, 0x80, 0x00, 0x00}},
	{TRANSFER_CARDOUT, "080000", ACTPRINT + ACTREVERSAL + ACTLOG + ACTTRACEADD, "66", "56", "000", "0200", "0210", "0400", {0x70, 0x24, 0x04, 0xC0, 0x30, 0xC0, 0x1A, 0x15}, {0x70, 0x24, 0x04, 0x80, 0x06, 0xC0, 0x00, 0x15}},
	{TRANSFER_REIMBURSED, "180000", ACTPRINT + ACTREVERSAL + ACTLOG + ACTTRACEADD, "66", "57", "000", "0200", "0210", "0400", {0x70, 0x24, 0x04, 0xC0, 0x30, 0xC0, 0x18, 0x15}, {0x70, 0x24, 0x04, 0x80, 0x06, 0xC0, 0x00, 0x15}},
	{TRANSFER_REPAYMENT, "280000", ACTPRINT + ACTREVERSAL + ACTLOG + ACTTRACEADD, "66", "58", "000", "0200", "0210", "0400", {0x70, 0x24, 0x04, 0xC0, 0x30, 0xC0, 0x18, 0x15}, {0x70, 0x24, 0x04, 0x80, 0x06, 0xC0, 0x00, 0x15}},
	{TRANSFER_CARDTOCARD, "080000", ACTPRINT + ACTREVERSAL + ACTLOG + ACTTRACEADD, "68", "56", "092", "0200", "0210", "0400", {0x70, 0x2c, 0x06, 0xc0, 0x30, 0xc0, 0x1a, 0x15}, {0x00, 0x00, 0x00, 0x00, 0x00, 0x80, 0x00, 0x00}},
	{RBPOINT_QUERY, "310007", ACTTRACEADD, "65", "55", "000", "0200", "0210", "0400", {0x60, 0x24, 0x04, 0xC0, 0x30, 0xC0, 0x18, 0x11}, {0x50, 0x20, 0x00, 0x00, 0x0a, 0x80, 0x00, 0x00}},
	{RBPOINT_CONSUME, "000007", ACTPRINT + ACTREVERSAL + ACTLOG + ACTTRACEADD, "65", "53", "000", "0200", "0210", "0400", {0x70, 0x24, 0x04, 0xC0, 0x30, 0xC0, 0x18, 0x15}, {0x70, 0x24, 0x04, 0x80, 0x36, 0xC0, 0x00, 0x15}},
	{RBPOINT_VOID, "200007", ACTPRINT + ACTREVERSAL + ACTLOG + ACTTRACEADD, "65", "55", "000", "0200", "0210", "0400", {0x70, 0x24, 0x04, 0xC0, 0x3C, 0xC0, 0x18, 0x19}, {0x70, 0x24, 0x04, 0x80, 0x06, 0xC0, 0x00, 0x19}},
	{QPBOC_SALE, "000000", ACTPRINT + ACTLOG + ACTTRACEADD, "00", "36", "000", "0200", "0210", "0400", {0x70, 0x3C, 0x06, 0xC0, 0x38, 0xC0, 0x9A, 0x13}, {0x70, 0x24, 0x06, 0x80, 0x36, 0xc0, 0x82, 0x11}},
	{ECC_SALE, "000000", ACTPRINT + ACTLOG + ACTTRACEADD, "00", "36", "000", "0200", "0210", "0400", {0x70, 0x3C, 0x06, 0xC0, 0x38, 0xC0, 0x9A, 0x13}, {0x70, 0x24, 0x06, 0x80, 0x36, 0xc0, 0x82, 0x11}},
	{ECC_ERRORUP, "000000", ACTLOG + ACTTRACEADD, "00", "38", "000", "0200", "0210", "0400", {0x70, 0x3C, 0x06, 0xC0, 0x38, 0xC0, 0x9A, 0x13}, {0x70, 0x24, 0x06, 0x80, 0x36, 0xc0, 0x82, 0x11}},
	{ECC_REFUND, "000000", ACTPRINT + ACTLOG + ACTTRACEADD, "00", "37", "000", "0220", "0230", "0400", {0x70, 0x3C, 0x06, 0xC0, 0x34, 0xC0, 0x98, 0x1B}, {0x70, 0x24, 0x04, 0x80, 0x06, 0xC0, 0x00, 0x19}},
	{ECC_LOAD, "700000", ACTPRINT + ACTREVERSAL + ACTLOG + ACTTRACEADD, "00", "80", "000", "0200", "0210", "0400", {0x70, 0x24, 0x06, 0x80, 0x30, 0xC0, 0x9A, 0x11}, {0x70, 0x24, 0x04, 0x80, 0x06, 0xC0, 0x00, 0x19}},
	{PASSWORD_VERIFY, "320000", ACTTRACEADD, "00", "01", "092", "0100", "0110", "0400", {0x60, 0x24, 0x06, 0xc0, 0x30, 0xE0, 0x9A, 0x17}, {0x00, 0x00, 0x00, 0x00, 0x00, 0x80, 0x00, 0x00}},
	{ACCOUNT_VERIFY, "330000", ACTTRACEADD, "00", "01", "092", "0100", "0110", "0400", {0x70, 0x24, 0x06, 0xc0, 0x30, 0xc2, 0x80, 0x13}, {0x00, 0x00, 0x00, 0x00, 0x00, 0x80, 0x00, 0x00}},
	{HOLDER_NAMEDISP, "330000", ACTTRACEADD, "00", "02", "000", "0100", "0110", "0400", {0x60, 0x24, 0x06, 0xc0, 0x30, 0xC0, 0x80, 0x13}, {0x00, 0x00, 0x00, 0x00, 0x00, 0x80, 0x00, 0x00}}};
...
ISO8583_FieldDef FieldLength_Table[64] = {
	...
	{3, 3, ISO_8583_UNPACKED},			// 49 -- ���� Code, Transaction
	...
	for (k = 0; k < 64; k++)
	{
		...
		case 60:
			...
			else
			{
				...
				*/
				if (memcmp(PosCom.stTrnTbl.SendMsgId, "03", 2) == 0 || memcmp(PosCom.stTrnTbl.SendMsgId, "05", 2) == 0 || memcmp(PosCom.stTrnTbl.SendMsgId, "06", 2) == 0 || memcmp(PosCom.stTrnTbl.SendMsgId, "08", 2) == 0)
				{
...
int PackCupBlock62(u8 *psFieldBuf)
{
	...
	case ICC_BATCHUP_TC: //
		...
		if ((ucType == 90) || (ucType == 91) || (ucType == 92) || (ucType == 93) || (ucType == 94)) //�⿨
